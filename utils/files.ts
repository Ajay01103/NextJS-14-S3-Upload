...
export const getFileDataFromKey = (key: string, modified?: string): FileDataDTO =>
  getFileDataFromUrl(getAbsoluteUrlFromKey(key), modified)

export const getAbsoluteUrlFromKey = (key: string) => `${config.s3.endpointUrl}/${key}`
